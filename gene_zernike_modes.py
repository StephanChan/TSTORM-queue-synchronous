...
astigmatism_at_0_modes=np.array(astigmatism_at_0_modes)/(count/23.0)
...
astigmatism_at_45_modes=np.array(astigmatism_at_45_modes)/(count/23.0)
...
coma_at_90=np.array(coma_at_90_modes)/(count/23.0)
...
coma_at_0=np.array(coma_at_0_modes)/(count/23.0)
...
trenfoil_at_90=np.array(trenfoil_at_90_modes)/(count/23.0)
...
trenfoil_at_45=np.array(trenfoil_at_45_modes)/(count/23.0)
...
spherical_abrration=np.array(spherical_abrration_modes)/(count/23.0)
...
quadrafoil_at_90=np.array(quadrafoil_at_90_modes)/(count/20.0)
...
quadrafoil_at_45=np.array(quadrafoil_at_45_modes)/(count/20.0)
